<?php
    ...
    if(iseet($_POST['logged_btn'])){
        $email = $_POST['user_email'];
        $password = $_POST['user_password'];

        $query = "SELECT user_id, user_name, user_email, user_password, user_phone, 
        user_address, user_city, user_photo FROM user WHERE user_email = ? AND user_password = ? LIMIT 1";
        ...
        if($stmt_login->execute()){
            ...
            if($stmt_login->num_rows() == 1){
                ...
                $_SESSION['user_phome'] = $user_phone;
                $_SESSION['user_adddress'] = $user_address;
                ...
                <form id ="login-form" method="POST" action="login.php >
                    ...
                    <div>
                        <div>
                            ...
                            <div>
                                <input type="submit" class="site_btn" id="login-btn"
